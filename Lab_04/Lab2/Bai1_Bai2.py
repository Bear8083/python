...
sv1 = SinhVien(2111878,"Vo Manh Quoc",datetime.strptime("7/7/2003",'%m/%d/%Y'))
sv2 = SinhVien(2110060,"Nguyen Viet Thang",datetime.strptime("8/8/2003",'%m/%d/%Y'))
sv3 = SinhVien(2111111,"Truong Quoc Hy",datetime.strptime("8/8/2003",'%m/%d/%Y'))
sv4 = SinhVien(2115266,"Nguyen Tran Ngoc Thang",datetime.strptime("8/8/2003",'%m/%d/%Y'))
sv5 = SinhVien(2115555,"Demisn sdaw",datetime.strptime("8/8/2003",'%m/%d/%Y'))
